...
func TestCreateActivity_HappyPath(t *testing.T) {
	...
	if fake.gotCreate.Subcategory != "climbing_gym" {
		t.Errorf("service received subcategory = %q, want climbing_gym", fake.gotCreate.Subcategory)
	}
}
