...
// (nearby-nudge-dismissed, home-base samples) via the shared boolFlag()
// helper, not a per-feature storage abstraction.
const flag = boolFlag('roamly:first-launch-seen');

export const hasSeenSplash = flag.read;
export const markSplashSeen = flag.write;
