...
// tripadvisor-marks-require-reviews (T2): the caller only ever mounts this
// component once `tripadvisorAttribution()` (the gated helper) confirms the
// row has a quotable review — `reviews` defaults to that non-empty shape
// here, matching the real call site's contract.
