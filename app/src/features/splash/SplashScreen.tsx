  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.destinationCtaGroup}>
...
const styles = StyleSheet.create({
  ...
  // and centers the destination text + CTA together within it, so the gap
  // between them stays the fixed GLOW_BLEED value instead of growing with
  // screen height.
  destinationCtaGroup: {
    flex: 1,
